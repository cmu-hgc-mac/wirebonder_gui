...
class SaveButton(QPushButton):
    ...
    def save(self):
        upload_front_wirebond(self.module_name, self.frontpage.techname.text(), self.frontpage.comments.toPlainText(), self.frontpage.wedgeid.text(), self.frontpage.spool.text(), self.frontpage.marked_done.isChecked(),self.frontpage.buttons)
        ...
        upload_back_wirebond(self.module_name, self.backpage.techname.text(), self.backpage.comments.toPlainText(), self.backpage.wedgeid.text(), self.backpage.spool.text(), self.backpage.marked_done.isChecked(),self.backpage.buttons)
