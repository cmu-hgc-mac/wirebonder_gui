...
class EncapsPage(QMainWindow):
    def __init__(self, parent = None):
        ...
        label = QLabel("Time of Encapsulation:", self)
        label.setGeometry(encap_left_align,40, 200, 25)
        label = QLabel("Date: ", self)
        label.setGeometry(encap_left_align, 40+25, 40, 25)
        self.enc_date = QLineEdit(self)
        self.enc_date.setGeometry(10 + label.geometry().left() + label.geometry().width(), 40+25, 150, 25)
        label = QLabel("Time: ", self)
        label.setGeometry(10 + self.enc_date.geometry().left() + self.enc_date.geometry().width(), 40+25, 40, 25)
        self.enc_time = QLineEdit(self)
        self.enc_time.setGeometry(10 + label.geometry().left() + label.geometry().width(), 40+25, 150, 25)
        self.set_to_now(self.enc_date, self.enc_time)
        nowbutton1 = GreyButton("Now", 50, 25, self)
        nowbutton1.setGeometry(10 + self.enc_time.geometry().left() + self.enc_time.geometry().width(), 40+25, 50, 25)
        ...
        label = QLabel("Date: ", self)
        label.setGeometry(encap_left_align,260+30-5, 40, 25)
        self.start_date = QLineEdit(self)
        self.start_date.setGeometry(10 + label.geometry().left() + label.geometry().width(),260+30-5, 150, 25)
        label = QLabel("Time: ", self)
        label.setGeometry(10 + self.start_date.geometry().left() + self.start_date.geometry().width(),260+30-5, 40, 25)
        self.start_time = QLineEdit(self)
        self.start_time.setGeometry(10 + label.geometry().left() + label.geometry().width(),260+30-5, 150, 25)
        nowbutton2 = GreyButton("Now", 50, 25, self)
        nowbutton2.setGeometry(10 + self.start_time.geometry().left() + self.start_time.geometry().width(), 260+30-5, 50, 25)
