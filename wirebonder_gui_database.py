...
class EncapsPage(QMainWindow):
    def __init__(self, parent = None):
        ...
        label.setGeometry(300,220+20, 100, 25)
        self.epoxy_batch = QLineEdit(self)
        self.epoxy_batch.setText("Waiting for batch...")
        self.epoxy_batch.setGeometry(300,245+20, 150, 25)
        

        lab6 = QLabel("Comments:", self)
        lab6.setGeometry(300,360+20, 150, 25)
        self.comments= QTextEdit(self)
        self.comments.setGeometry(300,385+20, 300, 150)

        label = QLabel("<b>Encapsulation</b> (YYYY/MM/DD, HH:MM in 24h time):", self)
        label.setGeometry(300,70+20, 400, 25)
        label = QLabel("Date: ", self)
        label.setGeometry(300,95+20, 100, 25)
        self.enc_date = QLineEdit(self)
        self.enc_date.setGeometry(340,95+20, 150, 25)
        label = QLabel("Time: ", self)
        label.setGeometry(500,95+20, 100, 25)
        self.enc_time = QLineEdit(self)
        self.enc_time.setGeometry(550,95+20, 150, 25)
        nowbutton1 = GreyButton("Now", 50+20, 25, self)
        nowbutton1.setGeometry(725, 95+20, 50, 25)
        ...
        label.setGeometry(300,120+20, 400, 25)
        label = QLabel("Date: ", self)
        label.setGeometry(300,145+20, 100, 25)
        self.start_date = QLineEdit(self)
        self.start_date.setGeometry(340,145+20, 150, 25)
        label = QLabel("Time: ", self)
        label.setGeometry(500,145+20, 100, 25)
        self.start_time = QLineEdit(self)
        self.start_time.setGeometry(550,145+20, 150, 25)
        nowbutton2 = GreyButton("Now", 50+20, 25, self)
        nowbutton2.setGeometry(725, 145+20, 50, 25)
        ...
        label.setGeometry(300,170+20, 400, 25)
        label = QLabel("Date: ", self)
        label.setGeometry(300,195+20, 100, 25)
        self.end_date = QLineEdit(self)
        self.end_date.setGeometry(340,195+20, 150, 25)
        label = QLabel("Time: ", self)
        label.setGeometry(500,195+20, 100, 25)
        self.end_time = QLineEdit(self)
        self.end_time.setGeometry(550,195+20, 150, 25)
        nowbutton2 = GreyButton("Now", 50+20, 25, self)
        nowbutton2.setGeometry(725, 195+20, 50, 25)
        nowbutton2.clicked.connect(lambda: self.set_to_now(self.end_date, self.end_time))

        label = QLabel("Temperature:", self)
        label.setGeometry(300,265+20, 150, 25)
        self.temperature = QLineEdit(self)
        self.temperature.setGeometry(300,290+20, 150, 25)
        label = QLabel("Relative Humidity:",self)
        label.setGeometry(500,265+20, 150, 25)
        self.rel_hum = QLineEdit(self)
        self.rel_hum.setGeometry(500,290+20, 150, 25)
